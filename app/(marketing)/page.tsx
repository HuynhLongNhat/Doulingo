...
const HomePage = () => {
  ...
  "
    >
      <div
        className="relative w-[240px] h-[240px] lg:w-[240px] 
      lg:h-[240px] mb-8 lg:mb-0 "
      >
        <Image src="/hero.svg" fill alt="hero" />
      </div>
      <div className="flex-1 flex flex-col items-center gap-y-8">
        <h1 className="text-xl lg:text-3xl font-bold text-neutral-600 max-w-[480px] text-center">
          Learn, practice, and master new language with Fluentify
        </h1>
          ...
          <ClerkLoaded>
            ...
            <SignedIn>
              <Button
                ...
                asChild
              >
                <Link href="/learn">Countinue Learning</Link>
              </Button>
            </SignedIn>
          </ClerkLoaded>
        </div>
